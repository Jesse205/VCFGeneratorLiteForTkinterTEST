...
from tkinter.constants import X, ACTIVE, RIGHT, BOTTOM, BOTH, W
...
class InvalidLinesWindow(ExtendedDialog):
    ...
    def _create_widgets(self):
        ...
        self.treeview = ScrolledTreeview(self, columns=("context",))
        self.treeview.column('#0', anchor=W, stretch=False, width=self.get_scaled(60), minwidth=self.get_scaled(45))
        self.treeview.column('context', anchor=W)
        self.treeview.heading('#0', text='行数', anchor=W)

...
1. 把名字和电话以每行 `姓名 电话号码 备注` 的格式复制到主界面的文本框中，其中备注可忽略。例如：
   ...
   ```
2. 点击“生成”，选择一个路径保存文件。
3. 您可以将生成后的 VCF 文件用在您需要的地方，详情请参阅下文 [使用 VCF 文件](#使用-vcf-文件)。
...
3. 在弹出的对话框中，点击 **选择文件** 选择框，选择您的 VCF 文件。
4. 点击 **开始导入**。
